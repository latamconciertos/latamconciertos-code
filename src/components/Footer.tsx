      ...
      <div className="relative max-w-7xl mx-auto px-5 sm:px-6 lg:px-8 py-12 md:py-16">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 md:gap-12 mb-10 md:mb-12">
          ...
          <div className="lg:col-span-5 text-center lg:text-left">
            ...
            <p className="text-texto-2 mb-5 text-sm leading-relaxed max-w-md mx-auto lg:mx-0">
        ...
        {/* Bottom Bar */}
        <div className="relative pt-6 md:pt-8 border-t border-linea">
          <div className="flex flex-col-reverse md:flex-row justify-between items-center gap-4">
            <p className="text-texto-2/80 text-[11px] md:text-xs text-center md:text-left">
