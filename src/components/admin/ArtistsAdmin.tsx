  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex justify-between items-center">
        <div>
          <h2 className="font-display uppercase tracking-[0.01em] text-2xl font-extrabold text-texto">Gestión de Artistas</h2>
          <p className="text-texto-2">Administra el catálogo de artistas</p>
        </div>
        <Button
