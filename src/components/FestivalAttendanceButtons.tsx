...
interface FestivalAttendanceButtonsProps {
    festivalId: string;
    compact?: boolean;
...
const FestivalAttendanceButtons = ({
    festivalId,
    compact = false,
    variant = 'default'
}: FestivalAttendanceButtonsProps) => {
        ...
        <div className="space-y-3">
            ...
            >
                <ToggleGroupItem
                    ...
                    aria-label="Voy a asistir"
                    disabled={loading}
                    className={`flex-1 gap-2 py-3 transition-all duration-200 ${interaction.attendanceType === 'attending'
                ...
                <ToggleGroupItem
                    ...
                    aria-label="Tentativo"
                    disabled={loading}
                    className={`flex-1 gap-2 py-3 transition-all duration-200 ${interaction.attendanceType === 'tentative'
...
export default FestivalAttendanceButtons;
