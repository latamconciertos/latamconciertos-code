            ...
            >
                ...
                <div className="pt-4 border-t">
                    <Button
                        ...
                        className="w-full h-12 gap-2 text-base font-semibold rounded-full border-0 bg-[linear-gradient(95deg,#7516E2,#E70485)] text-white shadow-[0_8px_32px_rgba(117,22,226,.45)] hover:opacity-95"
                    >
