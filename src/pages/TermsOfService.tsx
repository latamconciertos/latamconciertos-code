      ...
      <div className="dark font-fira min-h-screen bg-noche text-texto">
        ...
        <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 pt-24 md:pt-28 pb-12">
          ...
          <div className="prose prose-lg max-w-none space-y-6 text-texto-2">
            ...
            <section>
              <h2 className="font-display uppercase text-2xl font-extrabold tracking-[0.01em] text-foreground mb-3">1. Aceptación de Términos</h2>
              <p>
            ...
            <section>
              <h2 className="font-display uppercase text-2xl font-extrabold tracking-[0.01em] text-foreground mb-3">2. Uso del Servicio</h2>
              <p>
            ...
            <section>
              <h2 className="font-display uppercase text-2xl font-extrabold tracking-[0.01em] text-foreground mb-3">3. Cuentas de Usuario</h2>
              <p>
            ...
            <section>
              <h2 className="font-display uppercase text-2xl font-extrabold tracking-[0.01em] text-foreground mb-3">4. Contenido del Usuario</h2>
              <p>
            ...
            <section>
              <h2 className="font-display uppercase text-2xl font-extrabold tracking-[0.01em] text-foreground mb-3">5. Propiedad Intelectual</h2>
              <p>
            ...
            <section>
              <h2 className="font-display uppercase text-2xl font-extrabold tracking-[0.01em] text-foreground mb-3">6. Información de Terceros</h2>
              <p>
            ...
            <section>
              <h2 className="font-display uppercase text-2xl font-extrabold tracking-[0.01em] text-foreground mb-3">7. Limitación de Responsabilidad</h2>
              <p>
            ...
            <section>
              <h2 className="font-display uppercase text-2xl font-extrabold tracking-[0.01em] text-foreground mb-3">8. Indemnización</h2>
              <p>
            ...
            <section>
              <h2 className="font-display uppercase text-2xl font-extrabold tracking-[0.01em] text-foreground mb-3">9. Modificaciones del Servicio</h2>
              <p>
            ...
            <section>
              <h2 className="font-display uppercase text-2xl font-extrabold tracking-[0.01em] text-foreground mb-3">10. Cambios a los Términos</h2>
              <p>
            ...
            <section>
              <h2 className="font-display uppercase text-2xl font-extrabold tracking-[0.01em] text-foreground mb-3">11. Ley Aplicable</h2>
              <p>
            ...
            <section>
              <h2 className="font-display uppercase text-2xl font-extrabold tracking-[0.01em] text-foreground mb-3">12. Contacto</h2>
              <p>
