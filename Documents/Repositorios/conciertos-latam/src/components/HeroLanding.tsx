...
const HeroLanding = ({
  ...
  // Parallax effects - subtle and professional
  ...
  const blur = useTransform(scrollY, [windowHeight * 0.2, windowHeight * 0.6], [0, 8]);
  useEffect(() => {
  ...
  return <motion.div ref={containerRef} className="relative h-screen w-full overflow-hidden" style={{
    y
      ...
      {/* Aurora effect - same as AuroraBackground */}
      ...
      {/* Content container with smooth blur effect on scroll */}
      ...
      filter: useTransform(blur, v => `blur(${v}px)`)
        ...
        delay: 0.2
          ...
          <img src={logo} alt="Conciertos LATAM" className="h-52 sm:h-36 md:h-44 w-auto object-contain" />
        </motion.div>
